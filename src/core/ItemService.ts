...
import { BotShopReadService } from "./BotShopReadService.js";
import { CraftRecipeReadService } from "./CraftRecipeReadService.js";
import { PublicMarketReadService } from "./PublicMarketReadService.js";
...
import type { AutocompleteOption, BotShopListingView, CraftRecipeIngredientView, CraftRecipeView, InventoryItemView, ItemRarityView, ItemTemplateRow, ItemTemplateView, PublicMarketListingView } from "./ItemViewTypes.js";
...
export type {
    AutocompleteOption,
    BotShopListingView,
    CraftRecipeIngredientView,
    CraftRecipeView,
    InventoryItemView,
    ItemRarityView,
    ItemTemplateRow,
    ItemTemplateView,
    PublicMarketListingView,
} from "./ItemViewTypes.js";
...
export class ItemService {
    ...
    async searchPublicListings(query: string): Promise<DBResponse<AutocompleteOption[]>> {
        return PublicMarketReadService.getInstance().searchPublicListings(query);
    }

    async searchUserPublicListings(discordUserId: string, query: string): Promise<DBResponse<AutocompleteOption[]>> {
        return PublicMarketReadService.getInstance().searchUserPublicListings(discordUserId, query);
    }

    async searchBotShopListings(query: string): Promise<DBResponse<AutocompleteOption[]>> {
        return BotShopReadService.getInstance().searchBotShopListings(query);
    }

    async searchCraftRecipes(query: string): Promise<DBResponse<AutocompleteOption[]>> {
        return CraftRecipeReadService.getInstance().searchCraftRecipes(query);
    }
    ...
    async listCraftRecipes(): Promise<DBResponse<CraftRecipeView[]>> {
        return CraftRecipeReadService.getInstance().listCraftRecipes();
    }

    async getCraftRecipeById(recipeId: number): Promise<DBResponse<CraftRecipeView | null>> {
        return CraftRecipeReadService.getInstance().getCraftRecipeById(recipeId);
    }
    ...
    async listBotShop(): Promise<DBResponse<BotShopListingView[]>> {
        return BotShopReadService.getInstance().listBotShop();
    }
    ...
    async listPublicMarket(): Promise<DBResponse<PublicMarketListingView[]>> {
        return PublicMarketReadService.getInstance().listPublicMarket();
    }

    async listUserPublicMarket(discordUserId: string): Promise<DBResponse<PublicMarketListingView[]>> {
        return PublicMarketReadService.getInstance().listUserPublicMarket(discordUserId);
    }
