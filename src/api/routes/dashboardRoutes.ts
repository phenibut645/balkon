...
import { registerProfileRoutes } from "./dashboard/profileRoutes.js";
import { registerNotificationRoutes } from "./dashboard/notificationRoutes.js";
import { registerMarketRoutes } from "./dashboard/marketRoutes.js";
import { registerInventoryRoutes } from "./dashboard/inventoryRoutes.js";
...
export async function registerDashboardRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.post("/admin/items", { preHandler: [requireAuth, requireBotAdmin] }, async request => {
    ...
    const response = await ItemService.getInstance().createItemTemplate({
      ...
      nameRu: parseOptionalText(body.nameRu),
      nameEn: parseOptionalText(body.nameEn),
      nameEt: parseOptionalText(body.nameEt),
      descriptionRu: parseOptionalText(body.descriptionRu),
      descriptionEn: parseOptionalText(body.descriptionEn),
      descriptionEt: parseOptionalText(body.descriptionEt),
