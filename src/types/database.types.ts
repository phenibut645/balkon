...
export type DataBaseTables =
    ...
    | "notifications"
    | "member_roles"
    | "twitch_notification_channels"
    | "member_command_permissions"
    | "commands"
    | "member_items"
    | "item_public_market"
    | "item_general_store"
...
export interface NotificationsDB extends DefaultDBTable {
    member_id: number,
    type: string,
...
export interface StreamerOwnersDB extends DefaultDBTable {
    streamer_id: number;
    member_id: number;
    role: StreamerOwnerRole;
    created_at?: number | Date;
}

export interface StreamerTrustedUsersDB extends DefaultDBTable {
    streamer_id: number;
    member_id: number;
